...
public class AudioRecognizerWindow extends JFrame {
    ...
    void makeSpectrum(byte[] pcm, long songId, boolean isMatching) {

        final int totalSize = pcm.length;
        ...
        for (int times = 0; times < amountPossible; times++) {
            ...
            for (int i = 0; i < 4096; i++) {
                ...
                // part as 0:
                complex[i] = new Complex(pcm[(times * 4096) + i], 0);
            }
...
//        determineKeyPoints(results, songId, isMatching);
    ...
    public void createWindow() {
        ...
        showSpectrumButton.addActionListener(e -> {
            ...
            makeSpectrum(audioBytes, -1, false);
        });
        fileTextField = new JTextField(20);

        fileTextField.setText("/Users/beka/proj/commercial_detection/examples/long/output/test.wav");
